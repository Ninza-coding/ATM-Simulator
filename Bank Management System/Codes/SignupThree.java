...
public class SignupThree extends JFrame implements ActionListener{
	...
	SignupThree(String formno){
		...
		c7= new JCheckBox("I here by declares that the above enterd details are correct to the best of my knowledge");
